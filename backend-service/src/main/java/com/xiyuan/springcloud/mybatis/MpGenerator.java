package com.xiyuan.springcloud.mybatis;
...
public class MpGenerator {
    ...
    private static final String module = "backend-service";

    private static final String databasePropertiesPath = "configs/dev/backend-service.properties";
    ...
    private static final String basePackage = "com.xiyuan.springcloud.mybatis";
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (module != null && !module.isEmpty()) tempProjectDir += "/" + module + "/";
        ...
        String password;
        String url;
        if (databasePropertiesPath.endsWith(".yml")) {
            ...
            driverClassName = "" + propertySource.getProperty("spring.datasource.driver-class-name");
            username = "" + propertySource.getProperty("spring.datasource.username");
            password = "" + propertySource.getProperty("spring.datasource.password");
            url = "" + propertySource.getProperty("spring.datasource.url");
        }
        else {
            Properties properties = new Properties();
            properties.load(new FileInputStream(databasePropertiesPath));
